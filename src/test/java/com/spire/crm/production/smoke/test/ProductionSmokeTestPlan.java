package com.spire.crm.production.smoke.test;
...
public class ProductionSmokeTestPlan extends ProdUITestPlan {

	Logger LOGGER = Logger.getLogger(ProductionSmokeTestPlan.class.getName());

	@DataProvider(name = "ProductionSmokeTestPlan")
	public static Iterator<Object[]> getCandidateInfo(Method method) {

		Iterator<Object[]> objectsFromCsv = null;

		try {
			String fileName = "./src/test/java/com/spire/crm/production/smoke/test/ProductionSmokeTestPlan.csv";
			LinkedHashMap<String, Class<?>> entityClazzMap = new LinkedHashMap<String, Class<?>>();
			LinkedHashMap<String, String> methodFilter = new LinkedHashMap<String, String>();
			methodFilter.put(SpireTestObject.TEST_TITLE, method.getName());
			entityClazzMap.put("SpireTestObject", SpireTestObject.class);
			entityClazzMap.put("JobPostBean", JobPostBean.class);
			objectsFromCsv = SpireCsvUtil.getObjectsFromCsv(ProductionSmokeTestPlan.class, entityClazzMap, fileName,
					null, methodFilter);
		} catch (Exception e) {
			e.printStackTrace();
		}
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifyProfileCreation","SANITY" }, dataProvider = "ProductionSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifyActivityCreation" ,"SANITY"}, dataProvider = "ProductionSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifyProfileUpdation" ,"SANITY"}, dataProvider = "ProductionSmokeTestPlan" , retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifyProfileDetailsDeletion" ,"SANITY"}, dataProvider = "ProductionSmokeTestPlan" , retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifySkillsAddition" ,"SANITY"}, dataProvider = "ProductionSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifyActivityElements","SANITY" }, dataProvider = "ProductionSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifyCreateEmailTemplate" ,"SANITY"}, dataProvider = "ProductionSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifyCloneCampaign","SANITY" }, dataProvider = "ProductionSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	...
	@Test(groups = { "verifySearchResults" ,"SANITY"}, dataProvider = "ProductionSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * verifyAttachLabel
	 */
	@Test(groups = { "verifyAttachLabel" ,"SANITY"}, dataProvider = "ProductionSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifyHomePageElements" ,"SANITY"}, dataProvider = "ProductionSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	...
	@Test(groups = { "verifyPipeline" ,"SANITY"}, dataProvider = "ProductionSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	...
	@Test(groups = { "uploadFile" ,"SANITY"}, dataProvider = "ProductionSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	...
	@Test(groups = { "createNewJobPost","SANITY" }, dataProvider = "ProductionSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	...
	@Test(groups = { "postJobFromURL" ,"SANITY"}, dataProvider = "ProductionSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifyEngagementScore","SANITY" }, dataProvider = "ProductionSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	...
	@Test(groups = { "verifySimilarProfiles","SANITY" }, dataProvider = "ProductionSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
