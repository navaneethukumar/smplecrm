...
import com.spire.common.LocalTestUITestPlan;
...
public class LocalTestSmokeTestPlan extends LocalTestUITestPlan {

	Logger LOGGER = Logger.getLogger(LocalTestSmokeTestPlan.class.getName());

	@DataProvider(name = "LocalTestSmokeTestPlan")
	public static Iterator<Object[]> getCandidateInfo(Method method) {
		...
		try {
			...
			objectsFromCsv = SpireCsvUtil.getObjectsFromCsv(LocalTestSmokeTestPlan.class, entityClazzMap, fileName,
					null, methodFilter);
		} catch (Exception e) {
			e.printStackTrace();
		}
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifyProfileCreation","SANITY" }, dataProvider = "LocalTestSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifyActivityCreation" ,"SANITY"}, dataProvider = "LocalTestSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifyProfileUpdation" ,"SANITY"}, dataProvider = "LocalTestSmokeTestPlan" , retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifyProfileDetailsDeletion" ,"SANITY"}, dataProvider = "LocalTestSmokeTestPlan" , retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifySkillsAddition" ,"SANITY"}, dataProvider = "LocalTestSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifyActivityElements","SANITY" }, dataProvider = "LocalTestSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifyCreateEmailTemplate" ,"SANITY"}, dataProvider = "LocalTestSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifyCloneCampaign","SANITY" }, dataProvider = "LocalTestSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	...
	@Test(groups = { "verifySearchResults" ,"SANITY"}, dataProvider = "LocalTestSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * verifyAttachLabel
	 */
	@Test(groups = { "verifyAttachLabel" ,"SANITY"}, dataProvider = "LocalTestSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifyHomePageElements" ,"SANITY"}, dataProvider = "LocalTestSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	...
	@Test(groups = { "verifyPipeline" ,"SANITY"}, dataProvider = "LocalTestSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	...
	@Test(groups = { "uploadFile" ,"SANITY"}, dataProvider = "LocalTestSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	...
	@Test(groups = { "createNewJobPost","SANITY" }, dataProvider = "LocalTestSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	...
	@Test(groups = { "postJobFromURL" ,"SANITY"}, dataProvider = "LocalTestSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifyEngagementScore","SANITY" }, dataProvider = "LocalTestSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	...
	@Test(groups = { "verifySimilarProfiles","SANITY" }, dataProvider = "LocalTestSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
