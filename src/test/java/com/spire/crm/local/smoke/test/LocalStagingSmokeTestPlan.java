package com.spire.crm.local.smoke.test;
...
import com.spire.common.LocalStagingUITestPlan;
...
public class LocalStagingSmokeTestPlan extends LocalStagingUITestPlan {

	Logger LOGGER = Logger.getLogger(LocalStagingSmokeTestPlan.class.getName());

	@DataProvider(name = "LocalStagingSmokeTestPlan")
	public static Iterator<Object[]> getCandidateInfo(Method method) {

		Iterator<Object[]> objectsFromCsv = null;

		try {
			String fileName = "./src/test/java/com/spire/crm/local/smoke/test/LocalSmokeTestPlan.csv";
			LinkedHashMap<String, Class<?>> entityClazzMap = new LinkedHashMap<String, Class<?>>();
			LinkedHashMap<String, String> methodFilter = new LinkedHashMap<String, String>();
			methodFilter.put(SpireTestObject.TEST_TITLE, method.getName());
			entityClazzMap.put("SpireTestObject", SpireTestObject.class);
			entityClazzMap.put("JobPostBean", JobPostBean.class);
			objectsFromCsv = SpireCsvUtil.getObjectsFromCsv(LocalStagingSmokeTestPlan.class, entityClazzMap, fileName,
					null, methodFilter);
		} catch (Exception e) {
			e.printStackTrace();
		}
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifyProfileCreation","SANITY" }, dataProvider = "LocalStagingSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifyActivityCreation" ,"SANITY"}, dataProvider = "LocalStagingSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifyProfileUpdation" ,"SANITY"}, dataProvider = "LocalStagingSmokeTestPlan" , retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifyProfileDetailsDeletion" ,"SANITY"}, dataProvider = "LocalStagingSmokeTestPlan" , retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifySkillsAddition" ,"SANITY"}, dataProvider = "LocalStagingSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifyActivityElements","SANITY" }, dataProvider = "LocalStagingSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifyCreateEmailTemplate" ,"SANITY"}, dataProvider = "LocalStagingSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifyCloneCampaign","SANITY" }, dataProvider = "LocalStagingSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	...
	@Test(groups = { "verifySearchResults" ,"SANITY"}, dataProvider = "LocalStagingSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * verifyAttachLabel
	 */
	@Test(groups = { "verifyAttachLabel" ,"SANITY"}, dataProvider = "LocalStagingSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifyHomePageElements" ,"SANITY"}, dataProvider = "LocalStagingSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	...
	@Test(groups = { "verifyPipeline" ,"SANITY"}, dataProvider = "LocalStagingSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	...
	@Test(groups = { "uploadFile" ,"SANITY"}, dataProvider = "LocalStagingSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	...
	@Test(groups = { "createNewJobPost","SANITY" }, dataProvider = "LocalStagingSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	...
	@Test(groups = { "postJobFromURL" ,"SANITY"}, dataProvider = "LocalStagingSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifyEngagementScore","SANITY" }, dataProvider = "LocalStagingSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	...
	@Test(groups = { "verifySimilarProfiles","SANITY" }, dataProvider = "LocalStagingSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
