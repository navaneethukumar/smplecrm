...
import com.spire.common.DemoUITestPlan;
...
public class DemoSmokeTestPlan extends DemoUITestPlan {

	Logger LOGGER = Logger.getLogger(DemoSmokeTestPlan.class.getName());

	@DataProvider(name = "DemoSmokeTestPlan")
	public static Iterator<Object[]> getCandidateInfo(Method method) {
		...
		try {
			...
			objectsFromCsv = SpireCsvUtil.getObjectsFromCsv(DemoSmokeTestPlan.class, entityClazzMap, fileName,
					null, methodFilter);
		} catch (Exception e) {
			e.printStackTrace();
		}
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifyProfileCreation","SANITY" }, dataProvider = "DemoSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifyActivityCreation" ,"SANITY"}, dataProvider = "DemoSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifyProfileUpdation" ,"SANITY"}, dataProvider = "DemoSmokeTestPlan" , retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifyProfileDetailsDeletion" ,"SANITY"}, dataProvider = "DemoSmokeTestPlan" , retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifySkillsAddition" ,"SANITY"}, dataProvider = "DemoSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifyActivityElements","SANITY" }, dataProvider = "DemoSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifyCreateEmailTemplate" ,"SANITY"}, dataProvider = "DemoSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifyCloneCampaign","SANITY" }, dataProvider = "DemoSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	...
	@Test(groups = { "verifySearchResults" ,"SANITY"}, dataProvider = "DemoSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * verifyAttachLabel
	 */
	@Test(groups = { "verifyAttachLabel" ,"SANITY"}, dataProvider = "DemoSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifyHomePageElements" ,"SANITY"}, dataProvider = "DemoSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	...
	@Test(groups = { "verifyPipeline" ,"SANITY"}, dataProvider = "DemoSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	...
	@Test(groups = { "uploadFile" ,"SANITY"}, dataProvider = "DemoSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	...
	@Test(groups = { "createNewJobPost","SANITY" }, dataProvider = "DemoSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	...
	@Test(groups = { "postJobFromURL" ,"SANITY"}, dataProvider = "DemoSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	 ...
	 * @throws Exception
	 */
	@Test(groups = { "verifyEngagementScore","SANITY" }, dataProvider = "DemoSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
	...
	@Test(groups = { "verifySimilarProfiles","SANITY" }, dataProvider = "DemoSmokeTestPlan", retryAnalyzer = TestRetryAnalyzer.class)
