...
public class ProdUITestPlan extends TestPlan {
	
	

	//public LoginPageUtil loginPageUtil = null;
	public String USERNAME = "6015_batch@test.com";
	public String PASSWORD = "6015_B@tch";
	public String URL = "https://testvista.spire2grow.com/UI/src/app/index.html#/";
	public String DB_HOST = "mysql-prod-db.clapjg0gnhyn.us-east-1.rds.amazonaws.com";
	public String DB_PASSWORD = "SpireAiZie1qu123";
	public String SCHEMA_NAME = "test_schema";
	...
	public WebDriver login() throws InterruptedException{
		...
		userId="6015_batch@test.com";	
		password="6015_B@tch";
		url="https://testvista.spire2grow.com/UI/src/app/index.html#/";
