...
public class LocalStagingUITestPlan extends TestPlan {
	
	

	//public LoginPageUtil loginPageUtil = null;
	public String USERNAME = "tester@logica.com";
	public String PASSWORD = "spire@123";
	public String URL = "http://staging.vista.corp.spire.com/UI/src/app/index.html#/";
	public String DB_HOST = "mysql-prod-db.clapjg0gnhyn.us-east-1.rds.amazonaws.com";
	public String DB_PASSWORD = "SpireAiZie1qu123";
	public String SCHEMA_NAME = "logica_schema";
	public String SEARCH_MATCH_HOST = "192.168.2.75:8381";
	public static String CANDIDATE_ID = null;
	public String CANDIDATE_ID_SCORE = null;
	
	public LocalStagingUITestPlan(){
	...
	public WebDriver login() throws InterruptedException{
		...
		userId="tester@logica.com";	
		password="spire@123";
		url="http://staging.vista.corp.spire.com/UI/src/app/index.html#/";
