...
public class DemoUITestPlan extends TestPlan {
	
	

	//public LoginPageUtil loginPageUtil = null;
	public String USERNAME = "6004_batch@demo.com";
	public String PASSWORD = "6004_B@tch";
	public String URL = "https://spiredemovista.spire2grow.com/UI/src/app/index.html#/";
	public String DB_HOST = "demo.clapjg0gnhyn.us-east-1.rds.amazonaws.com";
	public String DB_PASSWORD = "abcd#abcd";
	public String SCHEMA_NAME = "demo_schema";
	...
	public WebDriver login() throws InterruptedException{
		...
		userId="6004_batch@demo.com";	
		password="6004_B@tch";
		url="https://spiredemovista.spire2grow.com/UI/src/app/index.html#/";
